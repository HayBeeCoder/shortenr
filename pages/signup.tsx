...
const Signup = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (input.email == "" || input.confirm_password || input.password)
    ...
    <section className="flex items-center justify-center  h-screen">
      ...
      <form className="justify-self-stretch space-y-5k" onSubmit={(e) => handleSubmit(e)}>
          ...
          <div>
            ...
            {showInputErrors && error.password != "" && (
          ...
          <div>
            ...
            />
            {showInputErrors && error.confirm_password != "" && (
              <p className="text-xs text-red-500 ">Passwords do not match!</p>
            )}
          </div>
          <div className="my-2">
            {serverResponse != "" && (
              <p className="text-xs text-red-500 ">{serverResponse}</p>
            )}
